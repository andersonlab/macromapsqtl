...
#Update to set reference condition
data.random = mash_update_data(data.random,ref=which(colnames(bhat_random)==baseline_cond))
data.strong = mash_update_data(data.strong,ref=which(colnames(bhat_strong)==baseline_cond))
