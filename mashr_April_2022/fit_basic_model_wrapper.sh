...
JOB_DIR="${workdir}"logs/cluster/macromap_fit_basic_model/
...
MEM=128000
QUEUE=long
JOB_NAME=macromap_fit_basic_model
GROUP=macromapsqtl
JOB_O="${JOB_DIR}"fit_basic_model.out
JOB_E="${JOB_DIR}"fit_basic_model.err

JOB_C="Rscript ${mash_scripts_dir}fit_basic_model.R ${MASH_OUTPUT_DIR}summstats/random.all.txt ${MASH_OUTPUT_DIR}summstats/strong.all.txt ${MASH_OUTPUT_DIR}models/basic_model.Rds"
